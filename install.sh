...
libsodium_url="${urladdr}libsodium-1.0.16.tar.gz"

mbedtls_file="mbedtls-2.9.0"
mbedtls_url="${urladdr}mbedtls-2.9.0-gpl.tgz"

shadowsocks_python_file="shadowsocks-master"
shadowsocks_python_url="${urladdr}master.zip"
shadowsocks_python_init="/etc/init.d/shadowsocks-python"
shadowsocks_python_config="/etc/shadowsocks-python/config.json"
shadowsocks_python_centos="${urladdr}shadowsocks"
shadowsocks_python_debian="${urladdr}shadowsocks-debian"

shadowsocks_r_file="shadowsocksr-3.2.2"
shadowsocks_r_url="${urladdr}3.2.2.tar.gz"
shadowsocks_r_init="/etc/init.d/shadowsocks-r"
shadowsocks_r_config="/etc/shadowsocks-r/config.json"
shadowsocks_r_centos="${urladdr}shadowsocksR"
shadowsocks_r_debian="${urladdr}shadowsocksR-debian"

shadowsocks_go_file_64="shadowsocks-server-linux64-1.2.1"
shadowsocks_go_url_64="${urladdr}shadowsocks-server-linux64-1.2.1.gz"
shadowsocks_go_file_32="shadowsocks-server-linux32-1.2.1"
shadowsocks_go_url_32="${urladdr}shadowsocks-server-linux32-1.2.1.gz"
shadowsocks_go_init="/etc/init.d/shadowsocks-go"
shadowsocks_go_config="/etc/shadowsocks-go/config.json"
shadowsocks_go_centos="${urladdr}shadowsocks-go"
shadowsocks_go_debian="${urladdr}shadowsocks-go-debian"

shadowsocks_libev_init="/etc/init.d/shadowsocks-libev"
shadowsocks_libev_config="/etc/shadowsocks-libev/config.json"
shadowsocks_libev_centos="${urladdr}shadowsocks-libev"
shadowsocks_libev_debian="${urladdr}shadowsocks-libev-debian"
...
get_libev_ver(){
    libev_ver=$(wget --no-check-certificate -qO- ${urladdr} | grep 'tag_name' | cut -d\" -f4)
...
download_files(){
    ...
    if   [ "${selected}" == "1" ]; then
        ...
        shadowsocks_libev_url="${urladdr}shadowsocks-libev-3.2.0.tar.gz"
...
install_shadowsocks_libev_obfs(){
    if [ "${libev_obfs}" == "y" ] || [ "${libev_obfs}" == "Y" ]; then
        cd ${cur_dir}
        git clone ${urladdr}simple-obfs.git
